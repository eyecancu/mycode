...
def main():
    ...
    switch = {"hostname": "sw1", "ip": "10.0.1.1", "verison": "1.2", "vendor": "cisco"}
    ...
    print(switch.get("lynx", "wrong key"))
    print("Third test - .get()" )
    print(switch.get("verison"))   # alternative to switch['version']
                                   # this key exists, so it will return a value of 
